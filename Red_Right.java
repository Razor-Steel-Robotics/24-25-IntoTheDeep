...
@Autonomous(name="Red Right", group = "Mr. Phil")
public class Red_Right extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.speak("This is Red Right Autonomous, ready to start ", "en","US");
        telemetry.addData(">", "Touch Play to run RED RIGHT Autonomous");
        telemetry.update();
        ...
        if (opModeIsActive()) {
            ...
            //put drive comands here
                ...
                if (step < 2) {
                    if (Rred > .001) {//Originally Lred, test Rred
                    ...
                    } else if (Lred > .001) {//Originally Rred, testing Lred
